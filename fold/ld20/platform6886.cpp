...
// ---------------------------------------------------------------------------
Platform_MT6886::Platform_MT6886()
{
    m_config.platform = PLATFORM_MT6886;
...
size_t Platform_MT6886::getLimitedExternalDisplaySize()
{
    // 4k resolution
    return 3840 * 2160;
}

bool Platform_MT6886::isUILayerValid(const sp<HWCLayer>& layer, int32_t* line)
{
    return PlatformCommon::isUILayerValid(layer, line);
}


bool Platform_MT6886::isMMLayerValid(const sp<HWCLayer>& layer, const int32_t pq_mode_id,
        int32_t* line)
{
