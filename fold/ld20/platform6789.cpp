...
// ---------------------------------------------------------------------------
Platform_MT6789::Platform_MT6789()
{
    m_config.platform = PLATFORM_MT6789;
...
size_t Platform_MT6789::getLimitedExternalDisplaySize()
{
    // 4k resolution
    return 3840 * 2160;
}

bool Platform_MT6789::isUILayerValid(const sp<HWCLayer>& layer, int32_t* line)
{
    return PlatformCommon::isUILayerValid(layer, line);
}


bool Platform_MT6789::isMMLayerValid(const sp<HWCLayer>& layer, const int32_t pq_mode_id,
        int32_t* line)
{
