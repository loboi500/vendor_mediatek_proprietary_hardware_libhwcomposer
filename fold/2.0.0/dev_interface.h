...
struct CreateDisplayInfo
{
    ...
    uint32_t drm_id_crtc_alternative;
};
...
public:
    ...
    virtual void setPowerMode(uint64_t dpy, uint32_t drm_id_crtc, int mode, bool panel_stay_on = false) = 0;
    ...
    virtual int setDsiSwitchEnable(bool /*enable*/) { return -ENOSYS; }

    virtual void setEnableFdDebug(bool /*enable*/) {};

    virtual int getPanelInfo(uint32_t /*drm_id_connector*/, const PanelInfo** /*panel_info*/) { return -ENOSYS; }
};
