...
LOCAL_MODULE := hwcomposer_fold_headers

LOCAL_EXPORT_C_INCLUDE_DIRS := \
	$(TOP)/$(MTK_ROOT)/hardware/hwcomposer/fold \
	$(TOP)/$(MTK_ROOT)/hardware/hwcomposer/fold/include \
...
ifdef MTK_GENERIC_HAL
LOCAL_MODULE := hwcomposer.mtk_fold.$(MTK_HWC_VERSION)
else
LOCAL_MODULE := hwcomposer.mtk_fold.$(MTK_PLATFORM_DIR).$(MTK_HWC_VERSION)
endif
...
LOCAL_HEADER_LIBRARIES := \
	...
	libhardware_headers \
	hwcomposer_fold_headers \
	libpq_headers \
	libnpagent_headers \
	libsync_headers \
	libgralloc_extra_headers \
	libladder_headers \
	libpq_perform_headers
